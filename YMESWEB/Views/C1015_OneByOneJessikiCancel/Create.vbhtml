...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-12" style="background-color:pink;max-width:353px">
            ...
            @Using Html.BeginForm("Create", "C1015_OneByOneJessikiCancel", FormMethod.Post, New With {.class = "Form-Horizontal",.id="C1010Form"})
