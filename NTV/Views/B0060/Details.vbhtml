...
<div>
    ...
    <dl class="dl-horizontal">
        ...
        <dt>
            @Html.DisplayNameFor(Function(model) model.FMTKBN)
        </dt>

        <dd>
            @Html.DisplayFor(Function(model) model.FMTKBN)
        </dd>
        ...
        <dt>
            @Html.DisplayNameFor(Function(model) model.SIYOFLG)
        </dt>

        <dd>
            @Html.DisplayFor(Function(model) model.SIYOFLG)
        </dd>

        <dt>
            @Html.DisplayNameFor(Function(model) model.SIYODATE)
        </dt>

        <dd>
            @Html.DisplayFor(Function(model) model.SIYODATE)
        </dd>
...
<p>
    @Html.ActionLink("Edit", "Edit", New With { .id = Model.HINANO }) |
