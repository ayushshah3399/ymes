...
@Using (Html.BeginForm())
    ...
    @<div class="form-horizontal">
        ...
        @Html.HiddenFor(Function(model) model.DNGNNO)
        ...
        <div class="form-group">
            @Html.LabelFor(Function(model) model.DATAFLG, htmlAttributes:= New With { .class = "control-label col-md-2" })
            <div class="col-md-10">
                @Html.EditorFor(Function(model) model.DATAFLG, New With { .htmlAttributes = New With { .class = "form-control" } })
                @Html.ValidationMessageFor(Function(model) model.DATAFLG, "", New With { .class = "text-danger" })
            </div>
        </div>

        <div class="form-group">
            @Html.LabelFor(Function(model) model.TOROKUYMD, htmlAttributes:= New With { .class = "control-label col-md-2" })
            <div class="col-md-10">
                @Html.EditorFor(Function(model) model.TOROKUYMD, New With { .htmlAttributes = New With { .class = "form-control" } })
                @Html.ValidationMessageFor(Function(model) model.TOROKUYMD, "", New With { .class = "text-danger" })
            </div>
        </div>
