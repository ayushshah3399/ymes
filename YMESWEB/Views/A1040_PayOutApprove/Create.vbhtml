...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-12" style="max-width:353px">
            ...
            @Using Html.BeginForm("Create", "A1040_PayOutApprove", FormMethod.Post, New With {.class = "Form-Horizontal"})
                ...
                @<text>
                    ...
                    <center>
                        <Button id="btnPrevious" name="btnPrevious" value="1" type="reset" Class="btn btn-secondary Button-Custom" onclick="location.href='@Url.Action("Index", "A1040_PayOutApprove")'">@LangResources.Common_Previous</Button>
