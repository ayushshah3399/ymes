...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-12" style="max-width:353px">
            ...
            @Using Html.BeginForm("Index", "A1030_PayOutInput", FormMethod.Post, New With {.class = "Form-Horizontal"})
                ...
                <div class="form-group form-group-Custom focus">
                    <div class="control-label control-label-Custom">@LangResources.A1030_03_Picking_NO</div>
