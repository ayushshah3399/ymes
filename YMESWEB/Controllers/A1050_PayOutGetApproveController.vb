...
Namespace Controllers
	Public Class A1050_PayOutGetApproveController
		Inherits Controller

		Dim Db As New Model1
		Dim StrPlantCode As String = Nothing

		' GET: A1050_PayOutGetApprove
		Function Index() As ActionResult
			...
			ViewData!ID = LangResources.A1050_01_Fn_ConfirmReceivingItem
			Return View()
		...
		Function Index(ByVal d_mes0100 As d_mes0100) As ActionResult
			...
			If objd_mes0100.Count > 0 Then
				...
				If objd_mes0060.Count > 0 Then
					...
					Return RedirectToAction("Create", "A1050_PayOutGetApprove", d_mes0100)
		...
		' GET: A1050_PayOutGetApprove/Details/5
		Function Details(ByVal id As Integer) As ActionResult
			Return View()
		End Function
		' GET: A1050_PayOutGetApprove/Create
		Function Create(ByVal d_mes0100 As d_mes0100) As ActionResult
			...
			If objd_mes0100.Count > 0 Then
				...
				Else
					...
					TempData("errorPicking_NODataNotFound") = LangResources.MSG_A1030_05_NoDatainMes0060
					ViewData!ID = LangResources.A1050_01_Fn_ConfirmReceivingItem
					Return RedirectToAction("Index", "A1050_PayOutGetApprove", d_mes0100)
		...
		' POST: A1050_PayOutGetApprove/Create
		<HttpPost()>
		...
		' GET: A1050_PayOutGetApprove/Edit/5
		Function Edit(ByVal id As Integer) As ActionResult
			Return View()
		End Function

		' POST: A1050_PayOutGetApprove/Edit/5
		<HttpPost()>
		...
		' GET: A1050_PayOutGetApprove/Delete/5
		Function Delete(ByVal id As Integer) As ActionResult
			Return View()
		End Function

		' POST: A1050_PayOutGetApprove/Delete/5
		<HttpPost()>
