...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-12" style="background-color:pink;max-width:353px">

            @Using Html.BeginForm("Index", "C1015_OneByOneJessikiCancel", FormMethod.Post, New With {.class = "Form-Horizontal"})
                ...
                <div Class="form-group form-group-Custom">
                    ...
                    <div class=" input-group">
                        <div class="comboField">
                            ...
                            @Html.EditorFor(Function(model) model.man_stat_cd, New With {.htmlAttributes = New With {.class = "form-control input-sm inputBox", .placeholder = LangResources.C1010_03_MStation_placeholder, .autocomplete = "off", .maxlength = 10, .style = "width:125px"}})
