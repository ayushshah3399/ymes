...
<div class="container-fluid">
	<div class="row justify-content-center">
        <div class="col-12" style="background-color:pink;max-width:353px" id="ContainerID_1">
            ...
            @Using Html.BeginForm("Create", "A1045_PayOutApproveCancle", FormMethod.Post, New With {.class = "Form-Horizontal"})
                ...
                @<text>
                    ...
                    <center>
                        <Button id="btnPrevious" name="btnPrevious" value="1" type="reset" Class="btn btn-secondary Button-Custom" onclick="location.href='@Url.Action("Index", "A1045_PayOutApproveCancle")'">@LangResources.Common_Previous</Button>
