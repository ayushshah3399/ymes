...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-12" style="max-width:353px">
            ...
            @Using Html.BeginForm("Create", "A1050_PayOutGetApprove", FormMethod.Post, New With {.class = "Form-Horizontal"})
                ...
                @<text>
                    ...
                    <center>
                        <Button id="btnPrevious" name="btnPrevious" value="1" type="reset" Class="btn btn-secondary Button-Custom" onclick="location.href='@Url.Action("Index", "A1050_PayOutGetApprove")'">@LangResources.Common_Previous</Button>
                    ...
                    <div Class="form-group form-group-Custom">
                        <Table Class="table table-striped table-fixed table-sm table-bordered table-margin">
                            ...
                            <tbody style="height: 230px;overflow-y: auto;width: 100%;display: block;border:ridge;border-width:thin">
