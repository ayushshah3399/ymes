...
<div class="container">
   @Using (Html.BeginForm("Edit", "A0140", routeValues:=Nothing, method:=FormMethod.Post, htmlAttributes:=New With {.id = "myForm"}))
        ...
        @<div class="form-horizontal">
            ...
            @Html.HiddenFor(Function(model) model.NAIYOCD)
