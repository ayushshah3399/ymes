...
<div class="container">
    <div class="row">
        <div class="col-md-7">
          ...
          @Using (Html.BeginForm("Create", "A0110", routeValues:=Nothing, method:=FormMethod.Post, htmlAttributes:=New With {.id = "myForm"}))
                ...
                @<div class="form-horizontal">
                    ...
                    @Html.ValidationSummary(True, "", New With {.class = "text-danger"})
                     ...
                     <div class="form-group">
                         @Html.LabelFor(Function(model) model.USERPWD, htmlAttributes:=New With {.class = "control-label col-md-3 text-warning", .for = "USERPWD"})
                         <div class="col-md-9">
                     ...
                     <div class="form-group">
                         @Html.LabelFor(Function(model) model.USERPWDCONFRIM, htmlAttributes:=New With {.class = "control-label col-md-3 text-warning", .for = "USERPWDCONFRIM"})
                         <div class="col-md-9">
                     ...
                     <div class="form-group">
                         ...
                         <div class="col-md-9">
                             <div class="checkbox">
                                 ...
                                 @Html.HiddenFor(Function(model) model.KOKYUTENKAI)
                    ...
                    <!--ASI[22 Nov 2019]: START-->
                    <div class="form-group">
                         <label class = "control-label col-md-3">スポーツカテゴリ</label>
                         <div class="col-md-6">
                             <!--<input id="sportCategory_val" style="width:100%; pointer-events:none; border:none;padding-top:11px;" />-->
                             @Html.HiddenFor(Function(model) model.ChiefFlgsComaSeperatedString, "")
                             @Html.HiddenFor(Function(model) model.SportCatCdComaSeperatedString, "")
                             ...
                             @*<textarea id="sportCategory_val" cols="50" readonly style="border:none;padding-top:10px;"></textarea>*@
                         </div>
                         <div class="col-md-3" >
    ...
    <div class="modal-dialog modal-sm-cat" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">スポーツカテゴリ</h4>
