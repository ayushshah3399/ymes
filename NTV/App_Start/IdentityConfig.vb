...
Public Class ApplicationSignInManager
    ...
    Public Overrides Function PasswordSignInAsync(userName As String, password As String, isPersistent As Boolean, shouldLockout As Boolean) As Task(Of SignInStatus)
